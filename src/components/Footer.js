...
const Footer = () => {
  return (
    <footer className="w-full bg-gradient-to-br from-[#5A53A7] via-[#55C3A9] to-[#54ACA4] text-white border-t border-gray-200">
      <div className="mx-auto px-[190px] py-12">
        <div className="flex flex-col md:flex-row justify-between gap-8">
          {/* Logo and tagline with social icons */}
          <div className="w-full md:w-1/4">
            ...
            <div className="flex space-x-3">
              <a href="#" className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#3b5998] hover:bg-opacity-90 transition">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                </svg>
              </a>
              
              <a href="#" className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#1DA1F2] hover:bg-opacity-90 transition">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="#" className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#E1306C] hover:bg-opacity-90 transition">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="#" className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#FF0000] hover:bg-opacity-90 transition">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" />
                </svg>
              </a>
              
              <a href="#" className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#0077B5] hover:bg-opacity-90 transition">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="w-full md:w-1/4">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-[#54ACA4] transition text-white text-opacity-80 hover:text-opacity-100">Flight</a></li>
              <li><a href="#" className="hover:text-[#54ACA4] transition text-white text-opacity-80 hover:text-opacity-100">Hotel</a></li>
              <li><a href="#" className="hover:text-[#54ACA4] transition text-white text-opacity-80 hover:text-opacity-100">Holidays</a></li>
              <li><a href="#" className="hover:text-[#54ACA4] transition text-white text-opacity-80 hover:text-opacity-100">Visa</a></li>
              <li><a href="#" className="hover:text-[#54ACA4] transition text-white text-opacity-80 hover:text-opacity-100">Promotions</a></li>
            </ul>
          </div>
          ...
          <div className="w-full md:w-1/4">
            ...
            <address className="not-italic text-white text-opacity-80">
              <p className="mb-2">3rd floor, Sharif Plaza, 39 Kemal Ataturk Avenue,</p>
              <p className="mb-4">Banani, Dhaka-1213.</p>
              
              <div className="flex items-center mb-2">
                <svg className="w-4 h-4 mr-2 text-[#54ACA4]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>09613-131415</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="#" className="hover:text-[#54ACA4] transition">View Map</a>
              </div>
            </address>
          </div>
        </div>
          ...
          <div className="flex items-center gap-6">
            <div>
              ...
              <div className="flex items-center space-x-4 text-white text-opacity-80">
                ...
                <span className="font-bold">BAS15</span>
              </div>
            </div>

            {/* Payment methods */}
            <div>
              <h4 className="text-sm font-medium mb-3 text-white">Payment Method</h4>
              <div className="flex space-x-3">
      ...
      <div className="bg-[#5A53A7] w-full py-4 border-t border-white border-opacity-20">
        <div className="mx-auto px-[190px] text-center text-sm text-white text-opacity-80">
          © 2025 Firsttrip. All Rights Reserved
        </div>
      </div>
    </footer>
  );
