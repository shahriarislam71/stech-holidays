...
const VisaDetails = ({ countryData }) => {
  ...
  // Dummy visa data with images
  const visaTypes = [
    {
      id: 'tourist',
      type: "Tourist Visa",
      image: "/countries/visa-photo-1.jpg",
      description: "For travelers visiting for tourism and leisure activities",
      mode: "Online/Embassy",
      ...
      policies: [
        "Visa approval is at the discretion of the immigration authorities",
        "Extensions may be possible at local immigration offices",
        "Overstaying may result in fines or deportation"
      ],
      guidelines: {
        whoCanApply: [
          "All nationals except restricted countries",
          "Applicants with no criminal record",
          "Those with sufficient funds for the stay"
        ],
        requiredDocuments: [
          "Completed application form",
          "Confirmed return ticket",
          "Travel insurance covering the stay duration",
          "Hotel bookings or invitation letter"
        ],
        additionalInfo: "Processing time may vary during peak seasons. Applicants are advised to apply at least 4 weeks before travel date."
      }
    },
    {
      id: 'business',
      ...
      description: "For professionals attending meetings, conferences or business activities",
      mode: "Online/Embassy",
      entry: "Multiple",
      ...
      policies: [
        "Cannot engage in paid work with this visa",
        "Must register with local authorities if staying over 30 days",
        "Business activities must be pre-approved"
      ],
      guidelines: {
        whoCanApply: [
        ...
        additionalInfo: "Additional documents may be requested based on nature of business activities."
      }
    },
    {
      id: 'student',
      type: "Student Visa",
      image: "/countries/visa-photo-2.jpg",
      description: "For international students enrolled in educational institutions",
      mode: "Embassy",
      entry: "Multiple",
      processing: "15-20 working days",
      validity: "1 year",
      stay: "Duration of study",
      fee: "BDT 12,000",
      serviceCharge: "BDT 1,000",
      requirements: [
      ...
      policies: [
        ...
        "Limited work hours permitted",
        "Must notify authorities of address changes"
      ],
      guidelines: {
        whoCanApply: [
          "Accepted students at recognized institutions",
        ...
        additionalInfo: "Visa must be converted to residence permit within 30 days of arrival."
      }
    }
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="relative h-80 rounded-2xl overflow-hidden mb-8 shadow-lg" style={{ background: `linear-gradient(135deg, ${colors.primary}, ${colors.secondary})` }}>
        <Image
          src="/countries/visa-photo-1.jpg"
          alt="Visa Banner"
          fill
                    ...
                    <div className="p-6 md:w-2/3">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          ...
                          <p className="font-medium" style={{ color: colors.textNavy }}>{visa.processing}</p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="font-medium" style={{ color: colors.textNavy }}>{visa.entry}</p>
                        </div>
                        <div>
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="p-6 md:w-2/3">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div>
                        <p className="text-sm text-gray-500">Processing Time</p>
                        <p className="font-medium" style={{ color: colors.textNavy }}>{currentVisa.processing}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">Validity</p>
                      ...
                      <div>
                        <p className="text-sm text-gray-500">Entry Type</p>
                        <p className="font-medium" style={{ color: colors.textNavy }}>{currentVisa.entry}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">Fees</p>
              ...
              >
                {currentVisa.requirements?.length > 0 ? (
                  <ul className="space-y-3 pl-5">
                    {currentVisa.requirements.map((item, index) => (
                      <li key={index} className="relative pl-6 before:absolute before:left-0 before:top-2 before:w-2 before:h-2 before:rounded-full" style={{ color: colors.textDark, '--tw-bg-opacity': 1, backgroundColor: colors.primary }}>
                        {item}
                      </li>
                    ))}
                  </ul>
                    ...
                    {currentVisa.guidelines?.whoCanApply?.length > 0 ? (
                      <ul className="space-y-3 pl-7">
                        {currentVisa.guidelines.whoCanApply.map((item, index) => (
                          <li key={index} className="relative before:absolute before:-left-4 before:top-2 before:w-1.5 before:h-1.5 before:rounded-full" style={{ color: colors.textDark, '--tw-bg-opacity': 1, backgroundColor: colors.primary }}>
                            {item}
                          </li>
                        ))}
                      </ul>
          ...
          <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <DetailItem 
                      ...
                      label="Entry Type"
                      value={selectedVisa.entry}
                    />
                    <DetailItem 
                      icon={<FaClock style={{ color: colors.primary }} />}
                      label="Processing Time"
                      value={selectedVisa.processing}
                    />
                    <DetailItem 
              ...
              <div className="mt-8 p-5 rounded-xl border" style={{ backgroundColor: colors.accent + '20', borderColor: colors.accent }}>
                ...
                <p className="text-gray-700">{selectedVisa.guidelines.additionalInfo}</p>
              </div>
            </div>
