...
export default function PromotionsBanner() {
  return (
    <div className="w-full relative h-50 md:h-96 overflow-hidden shadow-lg">
      {/* Banner Image */}
      <Image
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#5A53A7]/80 to-[#55C3A9]/80 flex items-center">
        <div className="px-4 md:px-[190px] w-full">
          <div className="max-w-2xl">
            ...
            <button className="bg-white text-[#5A53A7] px-4 py-2 md:px-6 md:py-3 rounded-lg font-medium hover:bg-white/90 transition-colors duration-200 text-sm md:text-base">
              Explore Offers
            </button>
          </div>
        </div>
