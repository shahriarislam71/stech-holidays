...
const Footer = () => {
  return (
    <footer className="w-full text-center bg-gradient-to-br from-[#5A53A7] via-[#55C3A9] to-[#54ACA4] text-white border-t border-gray-200">
      <div className="mx-auto px-4 md:px-[190px] py-8 md:py-12">
        <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-0">
          ...
          <div className="w-full md:w-1/4 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="text-sm text-white text-opacity-80 mb-6 max-w-xs">
  ...
  <ul className="space-y-2">
    ...
    <li>
      ...
      <div className="bg-[#5A53A7] w-full py-4 border-t border-white border-opacity-20">
        <div className="mx-auto px-4 md:px-[190px] text-center text-sm text-white text-opacity-80">
