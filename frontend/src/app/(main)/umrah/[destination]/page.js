        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="font-medium">{packageData.includes_flight ? 'Included' : 'Not Included'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div className="flex items-center p-3 rounded-lg bg-[#5A53A7]/10">
              ...
              <div>
                <p className="text-gray-700 font-medium">Hotel</p>
                <p className="text-sm text-gray-600">{packageData.includes_hotel ? 'Included' : 'Not Included'}</p>
              </div>
            </div>
            <div className="flex items-center p-3 rounded-lg bg-[#5A53A7]/10">
              <FaCar className="text-[#5A53A7] text-xl mr-3" />
              <div>
                <p className="text-gray-700 font-medium">Transport</p>
                <p className="text-sm text-gray-600">{packageData.includes_transport ? 'Included' : 'Not Included'}</p>
              </div>
            </div>
            <div className="flex items-center p-3 rounded-lg bg-[#5A53A7]/10">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">{packageData.includes_visa ? 'Included' : 'Not Included'}</p>
              </div>
            </div>
          </div>
