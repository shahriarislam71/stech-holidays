...
import { FaCar, FaHotel, FaPassport, FaPlane } from 'react-icons/fa';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success('Your Umrah package has been booked successfully!', {
          position: "top-center",
          autoClose: 5000,
        ...
        onClose();
        router.push('/profile/my-bookings?tab=umrah');
      } else {
            ...
            <div className="space-y-4">
              ...
              <Link
                href={{
                  pathname: '/login',
                  query: { 
                    redirect: `/umrah/${destination}/${packageData.id}/book`,
                    packageId: packageData.id 
                  }
                }}
