// (main)/profile/my-bookings/page.js
'use client';
...
// In your profile/my-bookings page
      ...
      if (umrahResponse.ok) {
        ...
        setBookings(prev => ({
          ...
          umrah: umrahData.map(booking => ({
            ...
            date: new Date(booking.created_at).toLocaleDateString(),
            departure_date: booking.departure_date,
            destination: 'Umrah Package', // Since Umrah is always to Mecca
            status: booking.status,
            price: `BDT ${booking.package?.price?.toLocaleString() || '0'}`,
            passenger: booking.contact_name,
            email: booking.email,
            ...
            <>
              <div>
                ...
                <div className="space-y-3">
                  ...
                  {/* Add similar sections for other booking types */}
                </div>
              </div>
...
<div className="border-b border-gray-200">
  <nav className="flex -mb-px">
    ...
    <button
      ...
      className={`flex-1 py-4 text-center border-b-2 font-medium text-sm flex items-center justify-center gap-2 ${activeCategory === 'umrah' ? 'border-[#54ACA4] text-[#54ACA4]' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
    >
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
      </svg>
                          ...
                          <div className="flex items-start">
                            ...
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                              ...
                              <div className="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3">
                                ...
                                {/* Add similar fields for other booking types */}
                              </div>
